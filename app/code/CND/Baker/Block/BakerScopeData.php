...
/**
 * Class BakerScopeData provide scope (website, store or store_group) information on front
 ...
 * @since 100.2.0
 */
class BakerScopeData extends \Magento\Framework\View\Element\Template
{
    /**
     ...
     *
     * Can be used when necessary to obtain website id of the current baker.
     *
     * @return integer
     * @since 100.2.0
     */
