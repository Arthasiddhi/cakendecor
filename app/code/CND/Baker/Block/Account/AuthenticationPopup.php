...
class AuthenticationPopup extends \Magento\Framework\View\Element\Template
{
    ...
    public function getConfig()
    {
        return [
            ...
            'bakerRegisterUrl' => $this->escapeUrl($this->getBakerRegisterUrlUrl()),
            'bakerForgotPasswordUrl' => $this->escapeUrl($this->getBakerForgotPasswordUrl()),
    ...
    /**
     * Get baker register url
     *
     * @return string
     */
    public function getBakerRegisterUrlUrl()
    {
        return $this->getUrl('baker/account/create');
    }

    /**
     * Get baker forgot password url
     *
     * @return string
     */
    public function getBakerForgotPasswordUrl()
    {
        return $this->getUrl('baker/account/forgotpassword');
    }
}
