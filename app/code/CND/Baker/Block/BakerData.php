 ...
 * @since 100.0.2
 */
class BakerData extends \Magento\Framework\View\Element\Template
{
    /**
     * @var array
     */
    ...
    /**
     * Get url for baker data ajax requests. Returns url with protocol matching used to request page.
     *
     * @param string $route
     * @return string Baker data url.
     */
    public function getBakerDataUrl($route)
    {
    ...
    {
        return (int)$this->_scopeConfig->getValue('baker/online_bakers/section_data_lifetime');
    }
