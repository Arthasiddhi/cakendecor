 ...
 */
namespace CND\Baker\Block\Adminhtml\System\Config;
...
class Validatevat extends \Magento\Config\Block\System\Config\Form\Field
{
     ...
     * @return \CND\Baker\Block\Adminhtml\System\Config\Validatevat
     */
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $this->addData(
            [
                ...
                'ajax_url' => $this->_urlBuilder->getUrl('baker/system_config_validatevat/validate'),
            ]
        );
