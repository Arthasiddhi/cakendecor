...
/**
 * Generic block that uses baker metatdata attributes.
 *
...
class GenericMetadata extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _setFieldset($attributes, $fieldset, $exclude = [])
    {
        ...
        foreach ($attributes as $attribute) {
            ...
            if (($inputType = $attribute->getFrontendInput()) && !in_array(
                ...
                $this->_applyTypeSpecificConfigBaker($inputType, $element, $attribute);
            }
        }
    }
     ...
     * @return void
     */
    protected function _applyTypeSpecificConfigBaker(
        $inputType,
        $element,
