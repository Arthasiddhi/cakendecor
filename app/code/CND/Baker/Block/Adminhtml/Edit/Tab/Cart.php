...
/**
 * Adminhtml baker orders grid block
 *
 * @api
 * @since 100.0.2
 */
class Cart extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        $this->setId('baker_cart_grid' . $this->getWebsiteId());
        parent::_prepareGrid();
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Product'),
                'index' => 'name',
                'renderer' => \CND\Baker\Block\Adminhtml\Edit\Tab\View\Grid\Renderer\Item::class
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Action'),
                'index' => 'quote_item_id',
                'renderer' => \CND\Baker\Block\Adminhtml\Grid\Renderer\Multiaction::class,
                'filter' => false,
                'sortable' => false,
                'actions' => [
                    [
    ...
    /**
     * Gets baker assigned to this block
     *
     * @return int
     */
    ...
    {
        return $this->getUrl('baker/*/cart', ['_current' => true, 'website_id' => $this->getWebsiteId()]);
    }
    ...
    protected function getQuote()
    {
        if (null === $this->quote) {
            ...
            try {
                $this->quote = $this->quoteRepository->getForBaker($bakerId, $storeIds);
