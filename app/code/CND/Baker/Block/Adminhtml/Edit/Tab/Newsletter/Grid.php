 ...
 */
namespace CND\Baker\Block\Adminhtml\Edit\Tab\Newsletter;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        return $this->getUrl('baker/*/newsletter', ['_current' => true]);
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Status'),
                'align' => 'center',
                'filter' => \CND\Baker\Block\Adminhtml\Edit\Tab\Newsletter\Grid\Filter\Status::class,
                'index' => 'queue_status',
                'renderer' => \CND\Baker\Block\Adminhtml\Edit\Tab\Newsletter\Grid\Renderer\Status::class
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'filter' => false,
                'sortable' => false,
                'renderer' => \CND\Baker\Block\Adminhtml\Edit\Tab\Newsletter\Grid\Renderer\Action::class
            ]
        );
