...
{
    const DEFAULT_ADDRESS_RENDERER = \CND\Baker\Block\Address\Renderer\DefaultRenderer::class;

    const XML_PATH_ADDRESS_TEMPLATE = 'baker/address_templates/';
    ...
    public function __construct(
        \CND\Baker\Model\Address\Config\Reader $reader,
