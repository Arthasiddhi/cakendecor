 ...
 *
 * @api
 * @method string getBakerGroupCode()
 * @method \CND\Baker\Model\Group setBakerGroupCode(string $value)
 * @method \CND\Baker\Model\Group setTaxClassId(int $value)
...
class Group extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'baker_group';
    ...
    {
        $this->_init(\CND\Baker\Model\ResourceModel\Group::class);
    }

    /**
     * Alias for setBakerGroupCode
     *
     * @param string $value
     * @return $this
     */
    ...
    {
        return $this->setBakerGroupCode($value);
    }

    /**
     * Alias for getBakerGroupCode
     *
     * @return string
     */
    public function getCode()
    {
        return $this->getBakerGroupCode();
    }
