...
class FileProcessor
{
    ...
    /**
     * Retrieve baker/index/viewfile action URL
     *
    ...
    public function getViewUrl($filePath, $type)
    {
        ...
        if ($this->entityTypeCode == \CND\Baker\Api\AddressMetadataInterface::ENTITY_TYPE_ADDRESS) {
        ...
        if ($this->entityTypeCode == \CND\Baker\Api\BakerMetadataInterface::ENTITY_TYPE_CUSTOMER) {
            $viewUrl = $this->urlBuilder->getUrl(
                'baker/index/viewfile',
