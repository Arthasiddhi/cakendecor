...
class ElementFactory
{
     ...
     * @param bool $isAjax
     * @return \CND\Baker\Model\Metadata\Form\AbstractData
     */
    public function create(
        ...
        if ($dataModelClass == \CND\Baker\Model\Attribute\Data\Postcode::class) {
            $dataModelClass = \CND\Baker\Model\Metadata\Form\Postcode::class;
        }
        if (!empty($dataModelClass)) {
            $dataModel = $this->_objectManager->create($dataModelClass, $params);
        } else {
            $dataModelClass = sprintf(
                'CND\Baker\Model\Metadata\Form\%s',
