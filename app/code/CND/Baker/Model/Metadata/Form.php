...
class Form
{
    ...
    /**
     * @var LocationMetadataInterface
     */
    protected $_locationMetadataService;

    /**
     * @var ServiceMetadataInterface
     */
    protected $_serviceMetadataService;
    ...
    /**
     * @var \CND\Baker\Api\Data\AttributeMetadataInterface[]
     */
     ...
     * @param LocationMetadataInterface $locationMetadataService
     * @param ServiceMetadataInterface $serviceMetadataService`
    ...
    public function __construct(
        ...
        LocationMetadataInterface $locationMetadataService,
        ServiceMetadataInterface $serviceMetadataService,
        ...
        $this->_serviceMetadataService = $serviceMetadataService;
        $this->_locationMetadataService = $locationMetadataService;
    ...
    public function getAttributes()
    {
        if (!isset($this->_attributes)) {
            if ($this->_entityType === BakerMetadataInterface::ENTITY_TYPE_CUSTOMER) {
                $this->_attributes = $this->_bakerMetadataService->getAttributes($this->_formCode);
            } elseif ($this->_entityType === AddressMetadataInterface::ENTITY_TYPE_ADDRESS) {
                $this->_attributes = $this->_addressMetadataService->getAttributes($this->_formCode);
            }elseif ($this->_entityType === LocationMetadataInterface::ENTITY_TYPE_LOCATION) {
                $this->_attributes = $this->_locationMetadataService->getAttributes($this->_formCode);
            }elseif ($this->_entityType === AddressMetadataInterface::ENTITY_TYPE_SERVICE) {
                $this->_attributes = $this->_addressMetadataService->getAttributes($this->_formCode);
            } else {
     ...
     * @return \CND\Baker\Api\Data\AttributeMetadataInterface|false
     */
     ...
     *
     * @param \CND\Baker\Api\Data\AttributeMetadataInterface $attribute
    ...
    protected function _getValidator(array $data)
    {
        ...
        $builder = $validatorFactory->createValidatorBuilder('baker', 'form');
