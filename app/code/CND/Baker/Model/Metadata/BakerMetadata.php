...
/**
 * Service to fetch baker related custom attributes
 */
class BakerMetadata implements BakerMetadataInterface
{
    /**
     * @var array
     */
    private $bakerDataObjectMethods;
    ...
    public function getAttributes($formCode)
    {
        ...
        foreach ($attributesFormCollection as $attribute) {
            /** @var $attribute \CND\Baker\Model\Attribute */
    ...
    {
        $customAttributes = [];
        if (!$this->bakerDataObjectMethods) {
            ...
            $this->bakerDataObjectMethods = array_diff_key($dataObjectMethods, $baseClassDataObjectMethods);
        }
        foreach ($this->getAllAttributesMetadata() as $attributeMetadata) {
            $attributeCode = $attributeMetadata->getAttributeCode();
            $camelCaseKey = SimpleDataObjectConverter::snakeCaseToUpperCamelCase($attributeCode);
            $isDataObjectMethod = isset($this->bakerDataObjectMethods['get' . $camelCaseKey])
                || isset($this->bakerDataObjectMethods['is' . $camelCaseKey]);
