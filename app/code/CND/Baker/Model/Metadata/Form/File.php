 ...
 */
namespace CND\Baker\Model\Metadata\Form;
...
class File extends AbstractData
{
     ...
     * @param \CND\Baker\Model\FileProcessorFactory|null $fileProcessorFactory
     * @SuppressWarnings(PHPMD.ExcessiveParameterList)
     */
    public function __construct(
        \Magento\Framework\Stdlib\DateTime\TimezoneInterface $localeDate,
        \Psr\Log\LoggerInterface $logger,
        \CND\Baker\Api\Data\AttributeMetadataInterface $attribute,
        ...
        \CND\Baker\Model\FileProcessorFactory $fileProcessorFactory = null
    ) {
     ...
     * {@inheritdoc}
     */
    public function outputValue($format = \CND\Baker\Model\Metadata\ElementFactory::OUTPUT_FORMAT_TEXT)
    {
        $output = '';
        if ($this->_value) {
            switch ($format) {
                case \CND\Baker\Model\Metadata\ElementFactory::OUTPUT_FORMAT_JSON:
