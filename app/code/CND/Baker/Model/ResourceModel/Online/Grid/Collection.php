 ...
 */
namespace CND\Baker\Model\ResourceModel\Online\Grid;
...
/**
 * Flat baker online grid collection
 *
...
class Collection extends SearchResult
{
    ...
    protected function _initSelect()
    {
        ...
        $this->getSelect()->joinLeft(
            ['baker' => $this->getTable('baker_entity')],
            'baker.entity_id = main_table.baker_id',
        ...
        $expression = $connection->getCheckSql(
            'main_table.baker_id IS NOT NULL AND main_table.baker_id != 0',
