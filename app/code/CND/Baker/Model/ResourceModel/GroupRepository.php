...
use CND\Baker\Model\ResourceModel\Group\Collection;
...
use CND\Baker\Api\Data\GroupExtensionInterface;

/**
 * Baker group CRUD class
 *
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class GroupRepository implements \CND\Baker\Api\GroupRepositoryInterface
{
    /**
    ...
    /**
     * @var \CND\Baker\Model\GroupRegistry
     */
    protected $groupRegistry;

    /**
     * @var \CND\Baker\Model\GroupFactory
     */
    ...
    /**
     * @var \CND\Baker\Api\Data\GroupSearchResultsInterfaceFactory
     */
    ...
    /**
     * @param \CND\Baker\Model\GroupRegistry $groupRegistry
     * @param \CND\Baker\Model\GroupFactory $groupFactory
     * @param \CND\Baker\Api\Data\GroupInterfaceFactory $groupDataFactory
     * @param \CND\Baker\Model\ResourceModel\Group $groupResourceModel
     * @param \Magento\Framework\Reflection\DataObjectProcessor $dataObjectProcessor
     * @param \CND\Baker\Api\Data\GroupSearchResultsInterfaceFactory $searchResultsFactory
     * @param \Magento\Tax\Api\TaxClassRepositoryInterface $taxClassRepositoryInterface
     * @param \Magento\Framework\Api\ExtensionAttribute\JoinProcessorInterface $extensionAttributesJoinProcessor
     * @param CollectionProcessorInterface $collectionProcessor
     */
    public function __construct(
        \CND\Baker\Model\GroupRegistry $groupRegistry,
        \CND\Baker\Model\GroupFactory $groupFactory,
        \CND\Baker\Api\Data\GroupInterfaceFactory $groupDataFactory,
        \CND\Baker\Model\ResourceModel\Group $groupResourceModel,
        \Magento\Framework\Reflection\DataObjectProcessor $dataObjectProcessor,
        \CND\Baker\Api\Data\GroupSearchResultsInterfaceFactory $searchResultsFactory,
     ...
     * {@inheritdoc}
     */
    public function save(\CND\Baker\Api\Data\GroupInterface $group)
    {
        $this->_validate($group);

        /** @var \CND\Baker\Model\Group $groupModel */
        $groupModel = null;
        ...
        try {
             ...
             */
            if ($e->getMessage() == (string)__('Baker Group already exists.')) {
                throw new InvalidTransitionException(__('Baker Group already exists.'));
            }
            throw $e;
        }
    ...
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        /** @var \CND\Baker\Model\ResourceModel\Group\Collection $collection */
        $collection = $this->groupFactory->create()->getCollection();
        $groupInterfaceName = \CND\Baker\Api\Data\GroupInterface::class;
        $this->extensionAttributesJoinProcessor->process($collection, $groupInterfaceName);
        $collection->addTaxClass();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \CND\Baker\Api\Data\GroupInterface[] $groups */
        $groups = [];
        /** @var \CND\Baker\Model\Group $group */
        foreach ($collection as $group) {
            /** @var \CND\Baker\Api\Data\GroupInterface $groupDataObject */
            $groupDataObject = $this->groupDataFactory->create()
                ->setId($group->getId())
    ...
    protected function translateField($field)
    {
        switch ($field) {
            case GroupInterface::CODE:
                return 'baker_group_code';
            case GroupInterface::ID:
                return 'baker_group_id';
     ...
     * @throws \Magento\Framework\Exception\StateException If baker group cannot be deleted
     ...
     *
     * @param \CND\Baker\Api\Data\GroupInterface $group
    ...
    /**
     * Verifies that the tax class model exists and is a baker tax class type.
     *
     * @param int $taxClassId The id of the tax class model to check
     * @param \CND\Baker\Api\Data\GroupInterface $group The original group parameters
     * @return void
    ...
    private function getCollectionProcessor()
    {
        if (!$this->collectionProcessor) {
            $this->collectionProcessor = \Magento\Framework\App\ObjectManager::getInstance()->get(
                'CND\Baker\Model\Api\SearchCriteria\GroupCollectionProcessor'
            );
        }
