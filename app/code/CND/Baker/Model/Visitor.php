...
class Visitor extends \Magento\Framework\Model\AbstractModel
{
    ...
    const XML_PATH_ONLINE_INTERVAL = 'baker/online_bakers/online_minutes_interval';
    ...
    {
        $this->_init(\CND\Baker\Model\ResourceModel\Visitor::class);
     ...
     * @return \CND\Baker\Model\Visitor
     */
    ...
    /**
     * Bind baker data when baker login
     *
     * Used in event "baker_login"
     *
     * @param   \Magento\Framework\Event\Observer $observer
     * @return  \CND\Baker\Model\Visitor
     */
    public function bindBakerLogin($observer)
    {
        /** @var \CND\Baker\Api\Data\BakerInterface $baker */
        $baker = $observer->getEvent()->getBaker();
        if (!$this->getBakerId()) {
            $this->setDoBakerLogin(true);
    ...
    /**
     * Bind baker data when baker logout
     *
     * Used in event "baker_logout"
     *
     * @param   \Magento\Framework\Event\Observer $observer
     * @return  \CND\Baker\Model\Visitor
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     */
    public function bindBakerLogout($observer)
    {
        if ($this->getBakerId()) {
            $this->setDoBakerLogout(true);
        }
        return $this;
    }
