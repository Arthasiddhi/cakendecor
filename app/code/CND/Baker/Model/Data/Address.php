...
class Address extends \Magento\Framework\Api\AbstractExtensibleObject implements
    \CND\Baker\Api\Data\AddressInterface
{
    /**
    ...
    {
        return $this->_get(self::BAKER_ID);
    }
    ...
    {
        return $this->setData(self::BAKER_ID, $bakerId);
    }

    /**
     * Set region
     *
     * @param \CND\Baker\Api\Data\RegionInterface $region
     * @return $this
     */
