...
class Attribute extends \Magento\Eav\Model\Attribute
{
     ...
     * Name of the module
     */
    const MODULE_NAME = 'Magento_Baker';
     ...
     * @var string
     */
    protected $_eventPrefix = 'baker_entity_attribute';
    ...
    /**
     * @var \CND\Baker\Model\Metadata\AttributeMetadataCache
     */
     ...
     * @param \CND\Baker\Model\Metadata\AttributeMetadataCache|null $attributeMetadataCache
    ...
    public function __construct(
        ...
        array $data = [],
        \CND\Baker\Model\Metadata\AttributeMetadataCache $attributeMetadataCache = null
    ) {
        $this->indexerRegistry = $indexerRegistry;
        $this->attributeMetadataCache = $attributeMetadataCache ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->get(\CND\Baker\Model\Metadata\AttributeMetadataCache::class);
        parent::__construct(
            $context,
            $registry,
            $extensionFactory,
    ...
    {
        $this->_init(\CND\Baker\Model\ResourceModel\Attribute::class);
    }
