...
use CND\Baker\BakerData\SectionPool;
...
class SectionPoolTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->identifierMock = $this->createMock(\CND\Baker\BakerData\Section\Identifier::class);
    ...
    public function testGetSectionsDataAllSections()
    {
        ...
        $sectionSourceMock = $this->createMock(\CND\Baker\BakerData\SectionSourceInterface::class);
     ...
     * @expectedExceptionMessage b doesn't extend \CND\Baker\BakerData\SectionSourceInterface
     */
