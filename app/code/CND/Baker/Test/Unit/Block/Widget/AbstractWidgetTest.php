...
use CND\Baker\Block\Widget\AbstractWidget;
...
class AbstractWidgetTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var \PHPUnit_Framework_MockObject_MockObject | \CND\Baker\Helper\Address */
    ...
    {
        $this->_addressHelper = $this->createMock(\CND\Baker\Helper\Address::class);

        $this->_block = new \CND\Baker\Block\Widget\AbstractWidget(
            $this->createMock(\Magento\Framework\View\Element\Template\Context::class),
            $this->_addressHelper,
            $this->getMockBuilder(\CND\Baker\Api\BakerMetadataInterface::class)->getMockForAbstractClass()
        );
    }
