...
use CND\Baker\Block\Widget\Dob;
...
class DobTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_block = new \CND\Baker\Block\Widget\Dob(
            $this->context,
    ...
    {
        $emptyValidationRule = $this->getMockBuilder(\CND\Baker\Api\Data\ValidationRuleInterface::class)
            ->disableOriginalConstructor()
