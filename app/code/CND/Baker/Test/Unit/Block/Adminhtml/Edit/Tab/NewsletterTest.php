...
{
    /**
     * @var \CND\Baker\Block\Adminhtml\Edit\Tab\Newsletter
     */
    protected $model;
    ...
    public function setUp()
    {
        ...
        $this->accountManagementMock = $this->createMock(\CND\Baker\Api\AccountManagementInterface::class);
        $this->urlBuilderMock = $this->createMock(\Magento\Framework\UrlInterface::class);
        $this->backendSessionMock = $this->getMockBuilder(\Magento\Backend\Model\Session::class)
            ->setMethods(['getBakerFormData'])
        ...
        $this->model = new \CND\Baker\Block\Adminhtml\Edit\Tab\Newsletter(
            $this->contextMock,
            $this->registryMock,
    ...
    public function testInitForm()
    {
        ...
        $this->registryMock->expects($this->exactly(3))
            ...
            ->willReturnMap(
                [
                    [RegistryConstants::CURRENT_CUSTOMER_ID, $bakerId],
        ...
        $subscriberMock->expects($this->once())->method('loadByBakerId')->with($bakerId)->willReturnSelf();
        ...
        $this->accountManagementMock->expects($this->once())->method('isReadOnly')->with($bakerId)
            ->willReturn(false);
        ...
        $this->backendSessionMock->expects($this->once())->method('getBakerFormData')->willReturn(null);
    ...
    public function testInitFormWithBakerFormData()
    {
        $bakerId = 1;
