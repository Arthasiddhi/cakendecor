 ...
 */
namespace CND\Baker\Test\Unit\Block\Adminhtml\From\Element;

/**
 * Test class for \CND\Baker\Block\Adminhtml\From\Element\Image
 */
class ImageTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \CND\Baker\Block\Adminhtml\Form\Element\Image
     */
    protected $image;
    ...
    protected function setUp()
    {
        ...
        $this->image = $objectManager->getObject(
            \CND\Baker\Block\Adminhtml\Form\Element\Image::class,
            [
    ...
    {
        $value = 'image.jpg';
        $url = 'http://example.com/backend/baker/index/viewfile/' . $value;
        ...
        $this->backendHelperMock->expects($this->once())
            ->method('getUrl')
            ->with('baker/index/viewfile', ['image' => $value])
