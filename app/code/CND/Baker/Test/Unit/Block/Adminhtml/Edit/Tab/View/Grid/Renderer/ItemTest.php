...
namespace CND\Baker\Test\Unit\Block\Adminhtml\Edit\Tab\View\Grid\Renderer;
...
class ItemTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var  \CND\Baker\Block\Adminhtml\Edit\Tab\View\Grid\Renderer\Item */
    protected $itemBlock;
    ...
    public function configure($amountOption, $withoutOptions = false)
    {
        ...
        $this->itemBlock = new \CND\Baker\Block\Adminhtml\Edit\Tab\View\Grid\Renderer\Item(
            $context,
            $productConfig,
            $productConfigPool
        );
