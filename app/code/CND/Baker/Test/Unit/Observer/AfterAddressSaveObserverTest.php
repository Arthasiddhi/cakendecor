...
use CND\Baker\Observer\AfterAddressSaveObserver;
...
class AfterAddressSaveObserverTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->vat = $this->getMockBuilder(\CND\Baker\Model\Vat::class)
        ...
        $this->group = $this->getMockBuilder(\CND\Baker\Api\Data\GroupInterface::class)
            ->setMethods(['getId'])
            ->getMockForAbstractClass();
        $this->group->expects($this->any())->method('getId')->willReturn(1);
        $this->groupManagement = $this->getMockBuilder(\CND\Baker\Api\GroupManagementInterface::class)
    ...
    public function testAfterAddressSaveDefaultGroup(
        ...
        $dataGroup = $this->getMockBuilder(\CND\Baker\Api\Data\GroupInterface::class)
            ->getMockForAbstractClass();
    ...
    public function testAfterAddressSaveNewGroup(
        ...
        $this->vat->expects($this->once())
            ->method('getBakerGroupIdBasedOnVatNumber')
            ->with($countryId, $validationResult, $store)
            ->willReturn($newGroupId);
        $this->vat->expects($this->any())
            ->method('getBakerVatClass')
