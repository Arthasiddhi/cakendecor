 ...
 */
namespace CND\Baker\Test\Unit\Ui\Component\DataProvider;
...
class DocumentTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var BakerMetadataInterface|MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->bakerMetadata = $this->getMockForAbstractClass(BakerMetadataInterface::class);
    ...
    /**
     * @covers \CND\Baker\Ui\Component\DataProvider\Document::getCustomAttribute
     */
    public function testGetGenderAttribute()
    {
        ...
        $this->bakerMetadata->expects(static::once())
    ...
    public function testGetGroupAttribute()
    {
        ...
        $this->bakerMetadata->expects(static::never())
            ->method('getAttributeMetadata');
