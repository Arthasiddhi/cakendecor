...
use CND\Baker\Ui\Component\Listing\Columns;
...
class ColumnsTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var \CND\Baker\Ui\Component\ColumnFactory|\PHPUnit_Framework_MockObject_MockObject */
    ...
    protected function setUp()
    {
        ...
        $this->columnFactory = $this->createPartialMock(
            \CND\Baker\Ui\Component\ColumnFactory::class,
            ['create']
        );
        $this->attributeRepository = $this->createMock(
            \CND\Baker\Ui\Component\Listing\AttributeRepository::class
        );
        $this->attribute = $this->createMock(\CND\Baker\Model\Attribute::class);
