...
/**
 * @covers \CND\Baker\Controller\Adminhtml\Index\Index
 */
class IndexTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \CND\Baker\Controller\Adminhtml\Index\Index
     */
    ...
    protected function setUp()
    {
        ...
        $this->sessionMock = $this->getMockBuilder(\Magento\Backend\Model\Session::class)
            ->disableOriginalConstructor()
            ->setMethods(['unsBakerData', 'unsBakerFormData'])
            ->getMock();
        ...
        $this->indexController = $objectManager->getObject(
            \CND\Baker\Controller\Adminhtml\Index\Index::class,
            [
