...
{
    /** @var \CND\Baker\Controller\Adminhtml\Index\InlineEdit */
    private $controller;
    ...
    /** @var \CND\Baker\Api\Data\AddressInterface|\PHPUnit_Framework_MockObject_MockObject*/
    private $address;
    ...
    protected function setUp()
    {
        ...
        $this->addressMapper = $this->createMock(\CND\Baker\Model\Address\Mapper::class);
        $this->bakerMapper = $this->createMock(\CND\Baker\Model\Baker\Mapper::class);
        ...
        $this->bakerRepository = $this->getMockForAbstractClass(
        ...
        $this->addressDataFactory = $this->createPartialMock(
            \CND\Baker\Api\Data\AddressInterfaceFactory::class,
            ['create']
        );
        ...
        $this->controller = $objectManager->getObject(
            \CND\Baker\Controller\Adminhtml\Index\InlineEdit::class,
            [
                'context' => $this->context,
                'resultJsonFactory' => $this->resultJsonFactory,
                'bakerRepository' => $this->bakerRepository,
                'addressMapper' => $this->addressMapper,
                'bakerMapper' => $this->bakerMapper,
    ...
    protected function prepareMocksForTesting($populateSequence = 0)
    {
        ...
        $this->bakerMapper->expects($this->once())
            ->method('toFlatArray')
            ->with($this->bakerData)
        ...
        $this->bakerData->expects($this->any())
            ->method('getId')
            ->willReturn(12);
    }
    ...
    public function testExecuteLocalizedException()
    {
        ...
        $this->messageManager->expects($this->once())
            ->method('addError')
            ->with('[Baker ID: 12] Exception message');
    ...
    public function testExecuteException()
    {
        ...
        $this->messageManager->expects($this->once())
            ->method('addError')
            ->with('[Baker ID: 12] We can\'t save the baker.');
        $this->logger->expects($this->once())
            ->method('critical')
            ->with($exception);
