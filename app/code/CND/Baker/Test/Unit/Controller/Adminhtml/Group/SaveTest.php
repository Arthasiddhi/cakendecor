 ...
 */
namespace CND\Baker\Test\Unit\Controller\Adminhtml\Group;

use CND\Baker\Api\Data\GroupInterfaceFactory;
use CND\Baker\Controller\Adminhtml\Group\Save;
...
class SaveTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->resultRedirect = $this->getMockBuilder(Redirect::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->bakerGroup = $this->getMockBuilder(\CND\Baker\Api\Data\GroupInterface::class)
            ->getMockForAbstractClass();
    ...
    public function testExecuteWithTaxClassAndException()
    {
        ...
        $this->messageManager->expects($this->once())
            ->method('addSuccess')
            ->with(__('You saved the baker group.'));
        ...
        $this->session->expects($this->once())
            ->method('setBakerGroupData')
            ->with(['baker_group_code' => $code]);
        $this->resultRedirect->expects($this->at(1))
            ->method('setPath')
            ->with('baker/group/edit', ['id' => $groupId]);
