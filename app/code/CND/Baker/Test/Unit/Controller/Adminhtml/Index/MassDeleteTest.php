...
{
    /**
     * @var \CND\Baker\Controller\Adminhtml\Index\MassDelete
     */
    ...
    protected function setUp()
    {
        ...
        $this->massAction = $objectManagerHelper->getObject(
            \CND\Baker\Controller\Adminhtml\Index\MassDelete::class,
            [
    ...
    public function testExecute()
    {
        ...
        $this->messageManagerMock->expects($this->once())
            ->method('addSuccess')
            ->with(__('A total of %1 record(s) were deleted.', count($bakersIds)));
