 ...
 */
namespace CND\Baker\Test\Unit\Controller\Adminhtml\System\Config\Validatevat;

class ValidateTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \CND\Baker\Controller\Adminhtml\System\Config\Validatevat\Validate
     */
    ...
    protected function setUp()
    {
        ...
        $this->controller = $objectManager->getObject(
            \CND\Baker\Controller\Adminhtml\System\Config\Validatevat\Validate::class,
            [
    ...
    public function testExecute()
    {
        ...
        $vatMock = $this->getMockBuilder(\CND\Baker\Model\Vat::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->objectManager->expects($this->once())
            ->method('get')
            ->with(\CND\Baker\Model\Vat::class)
            ->willReturn($vatMock);
