...
class ViewfileTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        /** @var \CND\Baker\Controller\Adminhtml\Index\Viewfile $controller */
        $controller = $this->objectManager->getObject(\CND\Baker\Controller\Adminhtml\Index\Viewfile::class);
        $controller->execute();
    }
    ...
    public function testExecuteInvalidFile()
    {
        ...
        $controller = $this->objectManager->getObject(
            \CND\Baker\Controller\Adminhtml\Index\Viewfile::class,
            [
