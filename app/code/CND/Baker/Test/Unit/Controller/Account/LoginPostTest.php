...
use CND\Baker\Controller\Account\LoginPost;
...
class LoginPostTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->accountManagement = $this->getMockBuilder(\CND\Baker\Api\AccountManagementInterface::class)
            ->getMockForAbstractClass();

        $this->url = $this->getMockBuilder(\CND\Baker\Model\Url::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->accountRedirect = $this->getMockBuilder(\CND\Baker\Model\Account\Redirect::class)
            ->disableOriginalConstructor()
            ->getMock();
