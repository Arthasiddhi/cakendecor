...
use CND\Baker\Model\Baker\Attribute\Backend\Website;
...
class WebsiteTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->testable = new \CND\Baker\Model\Baker\Attribute\Backend\Website($storeManager);
    }
    ...
    public function testBeforeSaveWithId()
    {
        ...
        $this->assertInstanceOf(
            \CND\Baker\Model\Baker\Attribute\Backend\Website::class,
