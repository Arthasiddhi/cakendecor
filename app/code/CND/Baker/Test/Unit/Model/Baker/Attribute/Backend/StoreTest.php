...
use CND\Baker\Model\Baker\Attribute\Backend\Store;
...
class StoreTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->testable = new \CND\Baker\Model\Baker\Attribute\Backend\Store($storeManager);
    }
    ...
    public function testBeforeSaveWithId()
    {
        ...
        $this->assertInstanceOf(
            \CND\Baker\Model\Baker\Attribute\Backend\Store::class,
