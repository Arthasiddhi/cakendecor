 ...
 */
namespace CND\Baker\Test\Unit\Model\Baker\Source;

use CND\Baker\Model\Baker\Source\Group;
use Magento\Framework\Module\Manager;
use CND\Baker\Api\GroupRepositoryInterface;
use Magento\Framework\Api\SearchCriteriaBuilder;
use Magento\Framework\Api\SearchCriteria;
use CND\Baker\Api\Data\GroupSearchResultsInterface;
...
class GroupTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testToOptionArray()
    {
        ...
        $groupTest = $this->getMockBuilder(\CND\Baker\Api\Data\GroupInterface::class)
            ->disableOriginalConstructor()
        ...
        $actualBakerGroups = $this->model->toOptionArray();

        $this->assertEquals($bakerGroups, $actualBakerGroups);

        foreach ($actualBakerGroups as $actualBakerGroup) {
            $this->assertInternalType('string', $actualBakerGroup['value']);
        }
    }
}
