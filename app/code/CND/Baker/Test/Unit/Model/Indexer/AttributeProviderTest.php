 ...
 */
namespace CND\Baker\Test\Unit\Model\Indexer;

use CND\Baker\Model\Baker;
use CND\Baker\Model\Indexer\AttributeProvider;
...
class AttributeProviderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAddDynamicData()
    {
        ...
        $collectionMock = $this->getMockBuilder(\Magento\Eav\Model\ResourceModel\Entity\Attribute\Collection::class)
            ->disableOriginalConstructor()
            ->getMock();
        /** @var \CND\Baker\Model\ResourceModel\Baker|\PHPUnit_Framework_MockObject_MockObject $entity */
        $entity = $this->getMockBuilder(\CND\Baker\Model\ResourceModel\Baker::class)
            ->disableOriginalConstructor()
            ->getMock();
        /** @var \CND\Baker\Model\Attribute|\PHPUnit_Framework_MockObject_MockObject $attribute */
        $attribute = $this->getMockBuilder(\CND\Baker\Model\Attribute::class)
            ->disableOriginalConstructor()
            ->setMethods(
                [
                    'setEntity',
