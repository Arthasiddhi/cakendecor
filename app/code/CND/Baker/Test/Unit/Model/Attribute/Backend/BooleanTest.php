...
namespace CND\Baker\Test\Unit\Model\Attribute\Backend;

class BooleanTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \CND\Baker\Model\Attribute\Backend\Data\Boolean
     */
    protected $model;

    protected function setUp()
    {
        $this->model = new \CND\Baker\Model\Attribute\Backend\Data\Boolean();
    }
    ...
    public function testBeforeSave($value, $defaultValue, $result)
    {
        ...
        $this->assertEquals($this->model, $this->model->beforeSave($bakerMock));
    }
