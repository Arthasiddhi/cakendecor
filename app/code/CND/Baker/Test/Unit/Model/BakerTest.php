<?php
/**
 * Unit test for baker service layer \CND\Baker\Model\Baker
 *
...
/**
 * Test class for \CND\Baker\Model\Baker testing
 */
...
class BakerTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var \CND\Baker\Model\AttributeFactory|\PHPUnit_Framework_MockObject_MockObject */
    protected $attributeFactoryMock;

    /** @var  \CND\Baker\Model\Attribute|\PHPUnit_Framework_MockObject_MockObject */
    protected $attributeBakerMock;
    ...
    protected function setUp()
    {
        ...
        $this->attributeFactoryMock = $this->createPartialMock(
            \CND\Baker\Model\AttributeFactory::class,
            ['create']
        );
        $this->attributeBakerMock = $this->createMock(\CND\Baker\Model\Attribute::class);
        $this->resourceMock = $this->createPartialMock(
            \CND\Baker\Model\ResourceModel\Baker::class, // \Magento\Framework\DataObject::class,
            ['getIdFieldName']
        );
     ...
     * @dataProvider isBakerLockedDataProvider
     */
    public function testIsBakerLocked($lockExpires, $expectedResult)
    {
        $this->_model->setLockExpires($lockExpires);
        $this->assertEquals($expectedResult, $this->_model->isBakerLocked());
    }

    /**
     * @return array
     */
    public function isBakerLockedDataProvider()
    {
        return [
    ...
    public function testIsConfirmationRequired(
        ...
        $this->_model->setData('id', $bakerId);
        $this->_model->setData('website_id', $websiteId);
        $this->_model->setData('email', $bakerEmail);
    ...
    public function testUpdateData()
    {
        ...
        $baker = $this->createPartialMock(
            \CND\Baker\Model\Data\Baker::class,
            [
                'getCustomAttributes',
                'getId',
            ]
        ...
        $this->dataObjectProcessor->expects($this->once())
            ...
            ->withConsecutive(
                [$baker, \CND\Baker\Api\Data\BakerInterface::class]
            )->willReturn($bakerDataAttributes);
        ...
        $this->_model->updateData($baker);

        foreach ($bakerDataAttributes as $key => $value) {
        ...
        $expectedResult['attribute_set_id'] =
            \CND\Baker\Api\BakerMetadataInterface::ATTRIBUTE_SET_ID_CUSTOMER;
