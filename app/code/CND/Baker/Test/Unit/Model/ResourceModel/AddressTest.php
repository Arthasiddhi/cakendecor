...
{
    /** @var \CND\Baker\Test\Unit\Model\ResourceModel\SubResourceModelAddress */
    ...
    protected function setUp()
    {
        ...
        $this->addressResource = (new ObjectManagerHelper($this))->getObject(
            \CND\Baker\Test\Unit\Model\ResourceModel\SubResourceModelAddress::class,
            [
                ...
                'bakerFactory' => $this->prepareBakerFactory()
            ]
        );
    }
    ...
    {
        /** @var $address \CND\Baker\Model\Address|\PHPUnit_Framework_MockObject_MockObject */
        $address = $this->createPartialMock(\CND\Baker\Model\Address::class, [
                '__wakeup',
                'getId',
                'getEntityTypeId',
                'getIsDefaultBilling',
        ...
        $this->addressResource->setType('baker_address');
    ...
    protected function prepareResource()
    {
        ...
        $resource->expects($this->any())->method('getTableName')->will($this->returnValue('baker_address_entity'));
    ...
    protected function prepareEavConfig()
    {
        ...
        $this->eavConfigType->expects($this->any())->method('getEntityTable')->willReturn('baker_address_entity');
 ...
 * @package CND\Baker\Test\Unit\Model\ResourceModel
 */
class SubResourceModelAddress extends \CND\Baker\Model\ResourceModel\Address
{
