 ...
 */
namespace CND\Baker\Test\Unit\Model\ResourceModel\Db\VersionControl;

use CND\Baker\Model\ResourceModel\Db\VersionControl\AddressSnapshot;
...
class AddressSnapshotTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @param bool $isBakerSaveTransaction
    ...
    public function testIsModified(
        ...
        $dataObjectMock->expects($this->once())
            ...
            ->willReturn(1);
        $dataObjectMock->expects($this->once())
            ->method('getIsBakerSaveTransaction')
            ->willReturn($isBakerSaveTransaction);
        $dataObjectMock->expects($this->any())
