...
namespace CND\Baker\Test\Unit\Model\ResourceModel\Group\Grid;

use Magento\Framework\Api\SearchCriteria;
use CND\Baker\Model\ResourceModel\Group\Grid\ServiceCollection;
use Magento\Framework\Api\SortOrder;

/**
 * Unit test for \CND\Baker\Model\ResourceModel\Group\Grid\ServiceCollection
 */
class ServiceCollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var \CND\Baker\Api\Data\GroupSearchResultsInterface */
    ...
    protected function setUp()
    {
        ...
        $this->serviceCollection = $this->objectManager
            ->getObject(
                \CND\Baker\Model\ResourceModel\Group\Grid\ServiceCollection::class,
                [
