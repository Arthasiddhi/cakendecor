...
/**
 * Unit test for registry \CND\Baker\Model\GroupRegistry
 */
class GroupRegistryTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \CND\Baker\Model\BakerGroupFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    private $groupFactory;

    protected function setUp()
    {
        $this->groupFactory = $this->getMockBuilder(\CND\Baker\Model\GroupFactory::class)
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->unit = new \CND\Baker\Model\GroupRegistry($this->groupFactory);
    }
    ...
    {
        $groupId = 1;
        $group = $this->getMockBuilder(\CND\Baker\Model\Group::class)
