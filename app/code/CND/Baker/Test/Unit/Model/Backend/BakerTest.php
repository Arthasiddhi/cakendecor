<?php
/**
 * Unit test for baker adminhtml model
 *
...
/**
 * Test class for \CND\Baker\Model\Backend\Baker testing
 */
namespace CND\Baker\Test\Unit\Model\Backend;
...
class BakerTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var \CND\Baker\Model\Backend\Baker */
    protected $_model;
    ...
    protected function setUp()
    {
        ...
        $this->_model = $helper->getObject(
            \CND\Baker\Model\Backend\Baker::class,
