<?php
/**
 * test CND\Baker\Model\Metadata\Form\Multiselect
 *
...
use CND\Baker\Model\Metadata\Form\Multiselect;
...
class MultiselectTest extends AbstractFormTestCase
{
    ...
    {
        return new \CND\Baker\Model\Metadata\Form\Multiselect(
            $this->localeMock,
            $this->loggerMock,
    ...
    public function testExtractValue($value, $expected)
    {
        ...
        $multiselect = $this->getMockBuilder(
            \CND\Baker\Model\Metadata\Form\Multiselect::class
