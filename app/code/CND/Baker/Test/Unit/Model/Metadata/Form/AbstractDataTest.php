<?php
/**
 * test CND\Baker\Model\Metadata\Form\AbstractData
 *
...
class AbstractDataTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var \CND\Baker\Test\Unit\Model\Metadata\Form\ExtendsAbstractData */
    protected $_model;
    ...
    protected function setUp()
    {
        ...
        $this->_attributeMock = $this->createMock(\CND\Baker\Api\Data\AttributeMetadataInterface::class);
        $this->_value = 'VALUE';
    ...
    {
        $validationRule = $this->getMockBuilder(\CND\Baker\Api\Data\ValidationRuleInterface::class)
