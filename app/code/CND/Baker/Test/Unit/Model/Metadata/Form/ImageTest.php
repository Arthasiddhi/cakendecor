...
class ImageTest extends AbstractFormTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->uploaderFactoryMock = $this->getMockBuilder(\Magento\Framework\File\UploaderFactory::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->fileProcessorMock = $this->getMockBuilder(\CND\Baker\Model\FileProcessor::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->imageContentFactory = $this->getMockBuilder(ImageContentInterfaceFactory::class)
            ...
            ->setMethods(['create'])
            ->getMock();
        $this->fileProcessorFactoryMock = $this->getMockBuilder(\CND\Baker\Model\FileProcessorFactory::class)
            ->setMethods(['create'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    /**
     * @param array $data
     * @return \CND\Baker\Model\Metadata\Form\File
     */
    private function initialize(array $data)
    {
        return new \CND\Baker\Model\Metadata\Form\Image(
            $this->localeMock,
            $this->loggerMock,
    ...
    public function testValidateMaxFileSize()
    {
        ...
        $validationRuleMock = $this->getMockBuilder(
            \CND\Baker\Api\Data\ValidationRuleInterface::class
    ...
    public function testCompactValueUiComponentBaker()
    {
        $originValue = 'filename.ext1';
    ...
    public function testCompactValueUiComponentBakerNotExists()
    {
        $originValue = 'filename.ext1';
