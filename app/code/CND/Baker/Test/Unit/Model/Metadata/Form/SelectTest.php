...
use CND\Baker\Model\Metadata\Form\Select;

/**
 * test CND\Baker\Model\Metadata\Form\Select
 */
class SelectTest extends AbstractFormTestCase
{
    ...
    {
        return new \CND\Baker\Model\Metadata\Form\Select(
            $this->localeMock,
            $this->loggerMock,
    ...
    {
        $option1 = $this->getMockBuilder(\CND\Baker\Api\Data\OptionInterface::class)
        ...
        $option2 = $this->getMockBuilder(\CND\Baker\Api\Data\OptionInterface::class)
            ->disableOriginalConstructor()
            ->setMethods(['getLabel', 'getValue'])
            ->getMockForAbstractClass();
        ...
        $option3 = $this->getMockBuilder(\CND\Baker\Api\Data\OptionInterface::class)
            ->disableOriginalConstructor()
            ->setMethods(['getLabel', 'getValue'])
            ->getMockForAbstractClass();
