<?php
/**
 * test CND\Baker\Model\Metadata\Form\Date
 *
...
{
    /** @var \CND\Baker\Model\Metadata\Form\Date */
    protected $date;
    ...
    protected function setUp()
    {
        ...
        $this->date = new \CND\Baker\Model\Metadata\Form\Date(
            $this->localeMock,
            $this->loggerMock,
    ...
    public function testOutputValue()
    {
        ...
        $date = new \CND\Baker\Model\Metadata\Form\Date(
            $this->localeMock,
            $this->loggerMock,
            $this->attributeMetadataMock,
            $this->localeResolverMock,
