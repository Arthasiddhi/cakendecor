<?php
/**
 * test CND\Baker\Model\Metadata\Form\Text
 *
...
use CND\Baker\Model\Metadata\Form\Text;
...
class TextTest extends AbstractFormTestCase
{
    ...
    {
        return new \CND\Baker\Model\Metadata\Form\Text(
            $this->localeMock,
            $this->loggerMock,
    ...
    {
        $minTextLengthRule = $this->getMockBuilder(\CND\Baker\Api\Data\ValidationRuleInterface::class)
        ...
        $maxTextLengthRule = $this->getMockBuilder(\CND\Baker\Api\Data\ValidationRuleInterface::class)
            ->disableOriginalConstructor()
            ->setMethods(['getName', 'getValue'])
            ->getMockForAbstractClass();
