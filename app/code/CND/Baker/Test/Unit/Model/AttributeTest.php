...
use CND\Baker\Model\Metadata\AttributeMetadataCache;
...
class AttributeTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \CND\Baker\Model\Metadata\AttributeMetadataCache|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function testInvalidate()
    {
        ...
        $this->indexerRegistryMock->expects($this->once())
            ->method('get')
            ->with(Baker::CUSTOMER_GRID_INDEXER_ID)
