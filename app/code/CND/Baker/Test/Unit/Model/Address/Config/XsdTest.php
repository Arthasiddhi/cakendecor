<?php
/**
 * Test for validation rules implemented by XSD schema for baker address format configuration
 *
...
class XsdTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_schemaFile = $urnResolver->getRealPath('urn:magento:module:CND_Baker:etc/address_formats.xsd');
    }
