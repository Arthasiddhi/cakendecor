...
class AbstractAddressTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var \CND\Baker\Model\Address\AbstractAddress  */
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->addressConfigMock = $this->createMock(\CND\Baker\Model\Address\Config::class);
        ...
        $this->model = $this->objectManager->getObject(
            \CND\Baker\Model\Address\AbstractAddress::class,
            [
