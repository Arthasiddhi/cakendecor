 ...
 */
namespace CND\Baker\Test\Unit\Model\Renderer;
...
class RegionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testRender($regionCollection)
    {
        ...
        $model = new \CND\Baker\Model\Renderer\Region($countryFactoryMock, $directoryHelperMock, $escaperMock);

        $static = new \ReflectionProperty(\CND\Baker\Model\Renderer\Region::class, '_regionCollections');
