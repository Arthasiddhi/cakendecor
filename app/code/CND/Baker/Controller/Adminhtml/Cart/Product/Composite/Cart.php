 ...
 */
namespace CND\Baker\Controller\Adminhtml\Cart\Product\Composite;
...
abstract class Cart extends \Magento\Backend\App\Action
{
    ...
    /**
     * Baker we're working with
     *
     * @var int id of the baker
     */
    protected $_bakerId;
    ...
    /**
     * Loads baker, quote and quote item by request params
     *
     * @return $this
    ...
    {
        $this->_bakerId = (int)$this->getRequest()->getParam('baker_id');
        if (!$this->_bakerId) {
            throw new \Magento\Framework\Exception\LocalizedException(__('No baker ID defined.'));
        }
        ...
        try {
            $this->_quote = $this->quoteRepository->getForBaker($this->_bakerId);
