 ...
 */
class Confirm extends \CND\Baker\Controller\AbstractAccount
{
    /**
    ...
    /**
     * Confirm baker account by id and confirmation key
     *
    ...
    public function execute()
    {
        ...
        try {
            $bakerId = $this->getRequest()->getParam('id', false);
            $key = $this->getRequest()->getParam('key', false);
            if (empty($bakerId) || empty($key)) {
                throw new \Exception(__('Bad request.'));
            }

            // log in and send greeting email
            $bakerEmail = $this->bakerRepository->getById($bakerId)->getEmail();
            $baker = $this->bakerAccountManagement->activate($bakerEmail, $key);
    ...
    protected function getSuccessMessage()
    {
        if ($this->addressHelper->isVatValidationEnabled()) {
            if ($this->addressHelper->getTaxCalculationAddressType() == Address::TYPE_SHIPPING) {
                ...
                $message = __(
                    'If you are a registered VAT baker, please click <a href="%1">here</a> to enter your shipping address for proper VAT calculation.',
                ...
                // @codingStandardsIgnoreStart
                $message = __(
                    'If you are a registered VAT baker, please click <a href="%1">here</a> to enter your billing address for proper VAT calculation.',
                    $this->urlModel->getUrl('baker/address/edit')
                );
                // @codingStandardsIgnoreEnd
            }
