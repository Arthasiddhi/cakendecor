...
use CND\Baker\Api\Data\AttributeMetadataInterface as AttributeMetadata;
use Magento\Framework\View\Element\UiComponentInterface;
use CND\Baker\Ui\Component\Listing\Column\InlineEditUpdater;
...
class Columns extends \Magento\Ui\Component\Listing\Columns
{
    ...
    /**
     * @var \CND\Baker\Ui\Component\Listing\AttributeRepository
     */
    protected $attributeRepository;

    /**
     * @var \CND\Baker\Ui\Component\Listing\Column\InlineEditUpdater
     */
    ...
    public function updateColumn(array $attributeData, $newAttributeCode)
    {
        ...
        if ($attributeData[AttributeMetadata::BACKEND_TYPE] != 'static') {
            ...
            if ($attributeData['entity_type_code'] == BakerMetadataInterface::ENTITY_TYPE_CUSTOMER
