 ...
 */
namespace CND\Baker\Ui\Component\DataProvider;
...
class Document extends \Magento\Framework\View\Element\UiComponent\DataProvider\Document
{
    ...
    private function setGenderValue()
    {
        ...
        try {
            $attributeMetadata = $this->bakerMetadata->getAttributeMetadata(self::$genderAttributeCode);
    ...
    /**
     * Update baker group value
     * Method set group code instead id value
     * @return void
     */
    private function setBakerGroupValue()
    {
