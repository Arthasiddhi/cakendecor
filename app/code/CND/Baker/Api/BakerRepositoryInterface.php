...
interface BakerRepositoryInterface
{
     ...
     *
     * @param \CND\Baker\Api\Data\BakerInterface $customer
     ...
     */
    public function save(\CND\Baker\Api\Data\BakerInterface $customer, $passwordHash = null);
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function delete(\CND\Baker\Api\Data\BakerInterface $customer);
