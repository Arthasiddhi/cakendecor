...
class Address extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    const XML_PATH_VIV_DISABLE_AUTO_ASSIGN_DEFAULT = 'baker/create_account/viv_disable_auto_group_assign_default';

    const XML_PATH_VIV_ON_EACH_TRANSACTION = 'baker/create_account/viv_on_each_transaction';

    const XML_PATH_VAT_VALIDATION_ENABLED = 'baker/create_account/auto_group_assign';

    const XML_PATH_VIV_TAX_CALCULATION_ADDRESS_TYPE = 'baker/create_account/tax_calculation_address_type';

    const XML_PATH_VAT_FRONTEND_VISIBILITY = 'baker/create_account/vat_frontend_visibility';

    /**
     * Possible baker address types
     */
    ...
    /**
     * Array of Baker Address Attributes
     *
    ...
    /**
     * Baker address config node per website
     *
     * @var array
     */
    protected $_config = [];
    ...
    /**
     * Baker Number of Lines in a Street Address per website
     *
     * @var array
     */
    ...
    /**
     * Return baker address config value by key and store
     *
     * @param string $key
     ...
     *
     * @param string $code
     * @return \CND\Baker\Block\Address\Renderer\RendererInterface|null
     */
    ...
    /**
     * Retrieve baker address type on which tax calculation must be based
     *
    ...
    /**
     * Check if VAT ID address attribute has to be shown on frontend (on Baker Address management forms)
     *
     * @return boolean
     */
